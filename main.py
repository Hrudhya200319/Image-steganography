...
def decode_lsb_image(encoded_image_path, output_path):
    ...
    for y in range(encoded_image.height):
        for x in range(encoded_image.width):
            ...
            decoded_pixel = [encoded_pixel[channel]
                             & 0x01 for channel in range(3)]
            # Scale to 0-255
            decoded_pixel = [pixel * 255 for pixel in decoded_pixel]
...
# Example usage
base_image_path = "image1.jpg"  # Replace with your base image path
secret_image_path = "image2.jpg"  # Replace with your secret image path
# Output path for encoded image
